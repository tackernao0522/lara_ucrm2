...
<template>
    ...
    <div v-if="data.type === 'decile'" class="lg:w-2/3 w-full mx-auto overflow-auto">
        <table class="table-auto w-full text-left whitespace-nowrap">
            ...
            <tbody>
                <tr v-for="item in data.data" :key="item.date">
                    <td class="border-b-2 px-4 py-3">{{ item.decile }}</td>
                    <td class="border-b-2 px-4 py-3">{{ item.average }}</td>
                    <td class="border-b-2 px-4 py-3">{{ item.totalPerGroup }}</td>
                    <td class="border-b-2 px-4 py-3">{{ item.totalRatio }}</td>
                </tr>
            </tbody>
        </table>
    </div>
