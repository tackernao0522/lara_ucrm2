                                            ...
                                            <div class="p-2 w-full">
                                                <div class="flex items-center">
                                                    ...
                                                    <input type="radio" id="is_selling" name="is_selling"
                                                        v-model="form.is_selling" value="1" class="mr-1">
                                                    <label for="is_selling" class="text-sm text-gray-600 mr-4">販売中</label>
                                                    <input type="radio" id="is_selling" name="is_selling"
                                                        v-model="form.is_selling" value="0" class="mr-1">
                                                    <label for="is_selling" class="text-sm text-gray-600">停止中</label>
                                                </div>
                                            </div>
                                            <div class="p-2 w-full">
                                                <button
