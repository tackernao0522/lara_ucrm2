                                                    ...
                                                    <div class="mt-2 space-y-2">
                                                        <div>
                                                            <input type="radio" id="gender0" name="gender"
                                                                v-model="form.gender" value="0" class="mr-1">
                                                            <label for="gender0"
                                                                class="text-sm text-gray-600 mr-4">男性</label>
                                                        </div>
                                                        <div>
                                                            <input type="radio" id="gender1" name="gender"
                                                                v-model="form.gender" value="1" class="mr-1">
                                                            <label for="gender1"
                                                                class="text-sm text-gray-600 mr-4">女性</label>
                                                        </div>
                                                        <div>
                                                            <input type="radio" id="gender2" name="gender"
                                                                v-model="form.gender" value="2" class="mr-1">
                                                            <label for="gender2"
                                                                class="text-sm text-gray-600 mr-4">その他</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
